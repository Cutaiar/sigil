      ...
      <CardContent className="space-y-4">
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Button variant="ghost" size="sm" onClick={toggleApiKeyVisibility} className="h-8 px-2">
          ...
          <div className="flex">
            <Input id="api-key" readOnly value={showApiKey ? apiKey : maskedApiKey} className="font-mono text-sm" />
            <Button variant="outline" size="icon" className="ml-2" onClick={() => copyToClipboard(apiKey, "key")}>
        ...
        <div className="space-y-2">
          ...
          <div className="flex">
            <Input id="api-url" readOnly value={fullUrl} className="font-mono text-sm" />
            <Button variant="outline" size="icon" className="ml-2" onClick={() => copyToClipboard(fullUrl, "url")}>
